...
% V_ind è una variabile che serve come guest iniziale durante il calcolo
% della velocità indotta e viene considerata come guest iniziale la
% velocità indotta calcolata allo step precedente, per cui è stat creata
% una variabile "persistent" ed all istante iniziale viene creata.
persistent V_ind
if isempty(V_ind)
    V_ind = 0;
end
...
% Calcolo forze aerodinamiche con velocità indotta
[F,M,V_ind]=AeroDynamics_FAST_IND([ux;uy;uz],[p;q;r],BoomInfo,V_ind);
